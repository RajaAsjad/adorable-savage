...
export default function ProgramPostForm({
    post = null,
    categories = [],
    submitRoute,
    method = 'post',
    ...
    const { data, setData, post: submitForm, processing, errors } = useForm({
        program_category_id: post?.program_category_id || categories[0]?.id || '',
        title: post?.title || '',
        image: null,
        remove_image: false,
                ...
                <div className="rounded-[28px] border border-black/5 bg-white p-8 shadow-[0_12px_40px_-18px_rgba(0,0,0,0.15)]">
                    ...
                    <div className="mt-6">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setData('program_category_id', e.target.value)
                            }
                        >
                        ...
                        <InputError
                            className="mt-2"
                            message={errors.program_category_id}
                        />
                    </div>
