...
export default function EventForm({
    ...
    const { data, setData, post: submitForm, processing, errors } = useForm({
        event_category_id: event?.event_category_id || categories[0]?.id || '',
        title: event?.title || '',
                ...
                <div className="rounded-[28px] border border-black/5 bg-white p-8 shadow-[0_12px_40px_-18px_rgba(0,0,0,0.15)]">
                    <div>
                        ...
                        <TextInput
                            ...
                            placeholder="Verses & Vibes: Open Mic Night"
                        />
                    ...
                    {event?.slug && (
                        <p className="mt-3 text-[13px] text-black/45">
                            Slug:{' '}
                            <span className="font-medium text-ink">{event.slug}</span>
                        </p>
                    )}
                    ...
                    <div className="mt-6">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setData('event_category_id', e.target.value)
                            }
                        >
                        ...
                        <InputError
                            className="mt-2"
                            message={errors.event_category_id}
                        />
                    </div>
