...
export default function Index({ categories }) {
    const destroyCategory = (id) => {
        if (! window.confirm('Move this program category to trash?')) {
            return;
        }

        router.delete(route('admin.program-categories.destroy', id));
    };

    return (
        <AdminLayout title="Program Categories">
            ...
            <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    <p className="mt-1 text-[14px] text-black/55">
                        Manage program category badges and groups.
                    </p>
                </div>
                <Link
                    href={route('admin.program-categories.create')}
                    ...
                    <tbody>
                        {categories.data.length === 0 && (
                            <tr>
                                ...
                                >
                                    No program categories yet. Add your first
                                    category.
                                </td>
                            </tr>
                        )}
