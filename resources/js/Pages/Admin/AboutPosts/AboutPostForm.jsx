...
export default function AboutPostForm({
    post = null,
    submitRoute,
    method = 'post',
}) {
                ...
                <div className="rounded-[28px] border border-black/5 bg-white p-8 shadow-[0_12px_40px_-18px_rgba(0,0,0,0.15)]">
                    ...
                    {post?.slug && (
                        <p className="mt-3 text-[13px] text-black/45">
                            Slug:{' '}
                            <span className="font-medium text-ink">{post.slug}</span>
                        </p>
                    )}

                    <div className="mt-6">
                        <InputLabel htmlFor="slogan_text" value="Slogan Text" />
                        <TextInput
                            id="slogan_text"
                            className="mt-2 block w-full"
                            value={data.slogan_text}
                            onChange={(e) => setData('slogan_text', e.target.value)}
                            placeholder="Healing • Addiction • Grief • Health"
                        />
                        <InputError className="mt-2" message={errors.slogan_text} />
                    </div>
