                    ...
                    <tbody>
                        ...
                        {pages.data.map((page) => (
                            ...
                            >
                                ...
                                <td className="px-6 py-4 text-sm capitalize text-black/65">
                                    {page.page_template.replace(/[-_]/g, ' ')}
                                </td>
                                <td className="px-6 py-4">
                                ...
                                <td className="px-6 py-4 text-right text-[12px] font-bold uppercase tracking-wide">
                                    ...
                                    <Link
                                        href={route('admin.pages.edit', page.id)}
                                        className="ms-4 text-ink hover:text-blush"
                                    >
                                        Edit
                                    </Link>
                                    <button
